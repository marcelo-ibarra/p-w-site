			...
			<div class="row">
				<div class="col-md-12">
					<div class="well">
						...
						<p>Got introduced to these new languages: HTML5, JavaScript, PHP, CSS, MySQL and Angular. Attending
							Bootcapm coders was quite a ride. Main lesson learned - NEVER to give uuuup!</p>
					</div>
				</div>
				<div class="col-md-6">
				</div>
